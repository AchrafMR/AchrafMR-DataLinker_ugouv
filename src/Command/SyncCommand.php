...
//                $tableName='fac_hosix';
                ...
                while ($moreData) {
                    ...
                    if ($currentTime > $stopTime) {
                        $output->writeln('Stopping synchronization: Reached the stop time of 6:30 AM.');
                        $this->updateSyncInfo($synchronisation, 'partial', 'Stopped at the scheduled stop time (6:30 AM).');
